...
const tasks1 = [
  ...
  { title: "title1", description: "desc1", status: taskStatus.PROGRESS, responsiblePerson: "John" },
  { title: "title2", description: "desc2", status: taskStatus.PROGRESS, responsiblePerson: "Jane" },
  { title: "title3", description: "desc3", status: taskStatus.PROGRESS, responsiblePerson: "Emma" },
